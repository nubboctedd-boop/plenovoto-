...
async def get_congresistas(user: str = Depends(get_current_user)):
    # ... (el resto del código sigue igual, pero ahora requiere auth)
    pass

# Nota: Para simplificar, aplicaremos el Dependency a nivel de APP o en cada ruta
# Usaremos un pequeño truco: redefinir las rutas críticas abajo o simplemente dejar el Depends en cada una.
